...
language: 中文
summary: >-
  青龙面板提供了每日京豆详情通知的功能，用户可以通过安装相应的依赖库并在脚本管理中新建一个名为xxx.py的文件来使用该功能。具体操作步骤包括在依赖管理处安装青龙面板所需的依赖库，将上述代码复制到脚本管理中的xxx.py文件中，替换变量以适应用户的需求，保存文件并设置定时任务，最后点击运行查看设置是否正确。
---
