...
language: 中文
summary: >-
  文章讨论了在基于Notion的博客系统中配置AI摘要的功能，并介绍了洪墨AI（原TianliGPT）作为插件的使用。文章首先解释了什么是AI摘要，它如何自动分析整篇文章内容并提取关键信息，以及它如何节省时间、提高内容精准度和增强用户体验。接着，文章详细介绍了如何在NotionNext项目中配置和使用洪墨AI，包括获取KEY、选择计费类型、填写项目名称和摘要语言等步骤。最后，文章还提供了一些关于如何解决“Rerfer与Url不匹配”问题的建议。
---
